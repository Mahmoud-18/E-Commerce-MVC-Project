...
namespace ECommerceMVC.Services
{
    public class ProductsServices
    {
        ...
        public ProductsServices(EcommerceDbContext _context, ProductRepository _productRepository)
        {
            context = _context;
        ...
        {
            List<ShoppingProductsViewModel> products = new();
            Category? cat =  context.Category.FirstOrDefault(i => i.Id == id);
            if (cat.ParentCategoryId != null)
            {
                var catProducts = context.ProductCategory.Include("Product").Where(i => i.CategoryId == id);
            ...
            {
                var cats = context.Category.Where(i => i.ParentCategoryId == id);
